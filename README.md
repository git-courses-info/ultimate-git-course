...
- `git revert `should be used to undo changes on a public branch, and `git reset` should be reserved for undoing changes on a private branch. NOTE: If you change anything while reverting, and then push, then if some else made a commit, you will delete their code.
